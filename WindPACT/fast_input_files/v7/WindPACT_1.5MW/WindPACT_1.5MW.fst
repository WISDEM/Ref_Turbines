...
"WindPACT_1.5MW_Tower.dat"    TwrFile - Name of file containing tower properties (quoted string)
---------------------- NACELLE-YAW ---------------------------------------------
...
---------------------- BLADE ---------------------------------------------------
"WindPACT_1.5MW_Blade.dat"    BldFile(1) - Name of file containing properties for blade 1 (quoted string)
"WindPACT_1.5MW_Blade.dat"    BldFile(2) - Name of file containing properties for blade 2 (quoted string)
"WindPACT_1.5MW_Blade.dat"    BldFile(3) - Name of file containing properties for blade 3 (quoted string) [unused for 2 blades]
---------------------- AERODYN -------------------------------------------------
"WindPACT_1.5MW_AD.ipt"    	  ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
